...
from construct.inference.data.vos_test_dataset import VOSTestDataset
from construct.inference.data.burst_test_dataset import BURSTTestDataset
from construct.model.construct import Construct
from construct.inference.inference_core import InferenceCore
from construct.inference.utils.results_utils import ResultSaver, make_zip
from construct.inference.utils.burst_utils import BURSTResultHandler
...
def eval_vos(cfg: DictConfig):
    ...
    for vid_reader in pbar:
        ...
        try:
            processor = InferenceCore(construct, cfg=cfg)
